			...
			<div class="container">
				<div class="row">
					<div class="booking-form">
						...
						<form action="/addmovie" method="post" onsubmit="">
						<div class="row ">
								<div class="col-sm-12">
									<div class="form-group ">
										<h1 class="text-center tk">Add New Movie</h1>
									</div>
								</div>
						</div>
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input class="form-control" name="movieId" required type="text" >
									</div>
								</div>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<span class="form-label">Movie Rating</span>
									<input class="form-control" name="movieRating" required type="text" >
								</div>
							</div>
						
						<div class="form-group col-sm-6">
							<span class="form-label">Poster URL</span>
							<input class="form-control" name="posterURL" required  type="text" >
						</div>
					</div>
						...
						<div class="row">
							...
							<div class="form-btn">
								<input type="submit" class="submit-btn" value="Add Movie">
							</div>
						</form>
						
						
						
						<form action="/delmovie" method="get" onsubmit="">
						<div class="row ">
								<div class="col-sm-12">
									<div class="form-group ">
										<h1 class="text-center tk">Delete Movie</h1>
									</div>
								</div>
						</div>
							<div class="row">
								<div class="col-sm-5">
									<div class="form-group">
										<h3 class="text-right tk">Enter Movie Id</h3>
						...
						<div class="row">
							...
							<div class="form-btn">
								<input type="submit" class="submit-btn" value="Delete Movie">
							</div>
						</form>
