						...
						<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<h1 class="text-center tk">Admin Login</h1>
									</div>
								</div>
								</div>
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input class="form-control" required name="adminEmail" id= "email" type="email" placeholder="Enter your email">
									</div>
								</div>
							
							<div class="form-group col-sm-6">
								<span class="form-label">Password</span>
								<input class="form-control" name="adminPass" required id="pass" type="password" placeholder="">
							</div>
						</div>
						<div class="row">
							...
							<div class="form-btn">
								...
								<b style="color:#fff" class="text-center">${auth }</b>
							</div>
						</form>
					</div>
				</div>
