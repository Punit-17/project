			...
			<div class="container">
				<div class="row">
					<div class="booking-form bform">
						...
						<form action="/invoice" method="post" onsubmit="">
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<span class="form-label">Email</span>
										<input class="form-control" required name="userEmail" id= "email" type="email" placeholder="Enter your email">
									</div>
								</div>
							
							<div class="form-group col-sm-6">
								<span class="form-label">Phone</span>
								<input class="form-control" required name="userMobile" id="mobile" type="tel" placeholder="Enter your phone number">
							</div>
						</div>
						<div class="row">
						...
						<input type="text" name="movieBooked" value="${movieBooked}" style="display:none;">
						<input type="text" name="seatsBooked" value="${seatSelected}" style="display:none;">
						<input type="text" name="bookingDate" value="${currDate}" style="display:none;">
							<div class="form-btn">
